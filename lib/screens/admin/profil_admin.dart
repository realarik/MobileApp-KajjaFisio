...
class _ProfileAdminPageState extends State<ProfileAdminPage> with TickerProviderStateMixin {
  ...
  Future<String?> _uploadImageToSupabase({File? file, Uint8List? bytes}) async {
    ...
    String fileExt = '.jpg';
    String fileName = '${user.uid}_admin_${DateTime.now().millisecondsSinceEpoch}$fileExt';
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Text('Keluar dari Akun?', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
          ],
        ),
        content: Text(
